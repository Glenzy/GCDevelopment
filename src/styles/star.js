...
export default function Star(props) {
  return (<svg data-name="floatingStar" id="floatingStar" className={`floatingStar ${props.style}`} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 10 10">
    <defs>
      <radialGradient id="floatingStarGradient" cx="2.5" cy="2.5" r="2.5" gradientUnits="userSpaceOnUse">
    ...
    <circle className="star" cx="2.5" cy="2.5" r="2.5"/>
  </svg>);
}
